...
import com.ismyself.user.pojo.Address;
import com.ismyself.user.pojo.User;
import com.ismyself.user.service.AddressService;
...
public class AddressController {
    ...
    public Result<List<Address>> list() {
        try {
            ...
            return new Result<>(true, StatusCode.OK, "查询地址成功", addresses);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return new Result<>(false, StatusCode.ERROR, "查询地址失败");
    }
