...
public class SeckillGoodsServiceImpl implements SeckillGoodsService {
     ...
     */
    @Override
    public SeckillGoods getOne(Long id, String time) {
        //查询redis
     ...
     */
    @Override
    public List<SeckillGoods> getDateList(String dateStr) {
        //返回根据指定时间的集合
        return redisTemplate.boundHashOps("SeckillGoods_" + dateStr).values();
    }
