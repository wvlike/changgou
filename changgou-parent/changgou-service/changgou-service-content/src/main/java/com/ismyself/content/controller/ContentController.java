package com.ismyself.content.controller;


import com.github.pagehelper.PageInfo;
import com.ismyself.content.service.ContentService;
...
public class ContentController {
    ...
    public Result<Content> findByCategoryId(@PathVariable("id") Long id){
        List<Content> contents = contentService.findByCategoryId(id);
        return new Result(true, StatusCode.OK,"根据categoryId查询成功",contents);
